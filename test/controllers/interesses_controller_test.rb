...
class InteressesControllerTest < ActionController::TestCase
  ...
  test "should create interess" do
    assert_difference('Interesse.count') do
      post :create, interess: { pessoa_id: @interess.pessoa_id, produto_id: @interess.produto_id, status: @interess.status }
    end
  ...
  test "should update interess" do
    patch :update, id: @interess, interess: { pessoa_id: @interess.pessoa_id, produto_id: @interess.produto_id, status: @interess.status }
    assert_redirected_to interess_path(assigns(:interess))
  end
